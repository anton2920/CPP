...
void readAllFields(student *array, std::size_t size) {
    ...
    for (std::size_t i = 0; i < size; ++i) {
        ...
        if (ans == "Y" || ans == "y" || ans == "yes") {
            ...
            student::date tmpDate {01, 01, 2000};
            ...
            unsigned long tmpPhone = 89000000000;
...
void print_1(student *array, std::size_t size, const std::string &faculty) {
